...
import '../css/TermsAgreementModal.css';

const TermsAgreementModal = ({ open, onClose, onAgree, userType }) => {
  ...
  return (
    ...
    >
      <DialogTitle className="terms-agreement-modal__header">
        ...
        <IconButton
          onClick={handleClose}
          className="terms-agreement-modal__close-btn"
          aria-label="close"
        >
          <Close />
        </IconButton>
      ...
      <DialogContent className="terms-agreement-modal__content">
        <Box className="terms-agreement-modal__scroll-container">
          ...
          <Divider className="terms-agreement-modal__divider" />
          ...
          <Typography variant="subtitle1" className="terms-agreement-modal__subsection-title">
      ...
      <DialogActions className="terms-agreement-modal__actions">
        <Box className="terms-agreement-modal__checkbox-container">
          <FormControlLabel
            control={
              <Checkbox
                checked={agreed}
                ...
                name="agreeToTerms"
                className="terms-agreement-modal__checkbox"
              />
            }
            label={
              <Typography variant="body2">
                I have read and agree to the Terms and Agreement and Privacy Policy
              </Typography>
            }
            className="terms-agreement-modal__checkbox-label"
          />
        </Box>
        <Box className="terms-agreement-modal__button-container">
          <Button 
            onClick={handleClose} 
            className="terms-agreement-modal__cancel-btn"
          >
            Cancel
          </Button>
          <Button
            ...
            variant="contained"
            disabled={!agreed}
            className="terms-agreement-modal__agree-btn"
          >
            Agree & Continue
          </Button>
        </Box>
