/**
 * Frontend utility functions for handling customer names and privacy
 */
 ...
 */
export function maskCustomerFromObject(customer) {
  if (!customer) {
    return "Anonymous";
  }
 ...
 */
export function getAvatarLetter(maskedName) {
