...
console.log('• Updated API to validate existence of followed stores before counting');
...
console.log('Numbers in profile match exactly with what users see in their lists.');