...
console.log(
  "✅ Followed Stores: Updates when customer follows/unfollows MSMEs"
);
console.log(
  "✅ Favorites: Updates when customer adds/removes favorite products"
);
...
console.log(
  "• When customer favorites a product → Favorite Products increases"
);
